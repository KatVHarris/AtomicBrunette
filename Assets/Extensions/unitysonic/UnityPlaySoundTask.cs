...
public class UnityPlaySoundTask : PlaySoundTask {
	public UnityPlaySoundTask(MonoBehaviour behaviour, SoundFragment soundFragment, Rosettastone.Speech.Logger logger, string identifier = ""): base(soundFragment, logger, identifier ) {
